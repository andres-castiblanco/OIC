...
@Component({
  selector: 'app-inf-fis-edit',
  templateUrl: './inf-fis-edit.component.html',
  styleUrls: ['./inf-fis-edit.component.css'],
})
export class InfFisEditComponent {
  constructor(
  ...
  formUserFis = this.fb.group(
    {
      ...
      atm2: [this.editar.infoFis.area_terreno, []],
      atha: [this.editar.infoFis.area_terreno, []],
      acm2: [this.editar.infoFis.area_construccion, []],
      apm2: [this.editar.infoFis.area_privada, []],
      apha: [
        this.editar.infoFis.area_cultivo,
        [
          Validators.maxLength(7),
          InfFisEditComponent.patternValidator(/^\d+$/, {
            hasNumber: true,
          }),
        ],
      ],
      ac: [
        this.editar.infoFis.ano_construccion,
        [
      ...
      conser: [this.editar.infoFis.conservacion],
      desecon: [this.editar.infoFis.destinacion_economica, Validators.required],
      altedif: [this.editar.infoFis.altura_edificio],
      numpis: [
        this.editar.infoFis.numero_piso,
        [
      ...
      tir: [this.editar.infoFis.tipo_inmueble_rural],
      tiptipo: [this.editar.infoFis.tipologia_tipo],
      edcul: [
        this.editar.infoFis.edad_cultivo,
        [
          Validators.maxLength(4),
          InfFisEditComponent.patternValidator(/^\d+$/, {
            hasNumber: true,
      ...
      tipcul: [this.editar.infoFis.tipo_cultivo],
      coef: [
        this.editar.infoFis.coeficiente,
        [
          Validators.maxLength(3),
          InfFisEditComponent.patternValidator(/^\d+$/, {
            hasNumber: true,
      ...
      serpubl: [this.editar.infoFis.servicios_publicos, Validators.required],
      estra: [
        this.editar.infoFis.estrato,
        [
      ...
      banos: [
        this.editar.infoFis.numero_banos,
        [
          Validators.maxLength(2),
          InfFisEditComponent.patternValidator(/^\d+$/, {
            hasNumber: true,
      ...
      numhabi: [
        this.editar.infoFis.numero_habitaciones,
        [
          Validators.maxLength(2),
          InfFisEditComponent.patternValidator(/^\d+$/, {
            hasNumber: true,
      ...
      numdep: [
        this.editar.infoFis.numero_depositos,
        [
          Validators.maxLength(2),
          InfFisEditComponent.patternValidator(/^\d+$/, {
            hasNumber: true,
      ...
      conanex: [
        this.editar.infoFis.construcciones_anexas,
    ...
    },
    {
      validator: [
        (group: any) => {
          if (
            this.editar.idenPredio.tipo_predio?.valueOf() === 'URBANO' ||
            this.editar.idenPredio.tipo_predio?.valueOf() ===
        ...
        InfFisEditComponent.areasValidaciones,
      ],
    }
  );
  ...
  controlEntrevariables = {
    val_area_terreno:
      ...
      this.editar.datGen.tipo_inmueble?.valueOf() === 'CASA' ||
      this.editar.datGen.tipo_inmueble?.valueOf() === 'CASA_CAMPESTRE' ||
      this.editar.datGen.tipo_inmueble?.valueOf() === 'CASA_LOTE' ||
      this.editar.datGen.tipo_inmueble?.valueOf() === 'BODEGA' ||
      this.editar.datGen.tipo_inmueble?.valueOf() === 'CABAÑA' ||
      this.editar.datGen.tipo_inmueble?.valueOf() === 'OTRO'
        ? true
        : false,
    val_n_lote:
      this.editar.datGen.tipo_inmueble?.valueOf() === 'LOTE' ? false : true,
    val_area_privada:
      ...
      this.editar.idenPredio.condicion_juridica?.valueOf() ===
        ...
        : false,
    val_tipo_rural:
      this.editar.idenPredio.tipo_predio?.valueOf() === 'RURAL' ? true : false,
    val_n_lote_finca:
      this.editar.datGen.tipo_inmueble?.valueOf() === 'FINCA' ||
      this.editar.datGen.tipo_inmueble?.valueOf() === 'LOTE'
        ? true
  ...
  procesar() {
    ...
    this.objDatFis.id_oferta = this.editar.idenPredio.id_oferta?.valueOf();
    this.objDatFis.area_terreno =
      this.editar.idenPredio.tipo_predio === 'RURAL'
    ...
    if (
      ...
      JSON.stringify(this.editar.infoFis) !== JSON.stringify(this.objDatFis) &&
      ...
      this.api
        ...
        .subscribe((resDatFis) => {
          if (resDatFis.status === '200 OK') {
            ...
            this.editar.setInfoFisPredio = this.objDatFis;

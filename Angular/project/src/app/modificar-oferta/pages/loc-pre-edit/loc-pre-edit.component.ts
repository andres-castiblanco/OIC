...
@Component({
  selector: 'app-loc-pre-edit',
  templateUrl: './loc-pre-edit.component.html',
  styleUrls: ['./loc-pre-edit.component.css'],
})
export class LocPreEditComponent {
  constructor(
  ...
  formUserLoca = this.fb.group({
    idoferta: [
      { value: this.editar.idenPredio.id_oferta, disabled: true },
      Validators.required,
    ],
    dep: [this.editar.locPre.departamento, Validators.required],
    mun: [this.editar.locPre.municipio, Validators.required],
    nombar: [this.editar.locPre.barrio, [Validators.maxLength(30)]],
    nomver: [this.editar.locPre.vereda, [Validators.maxLength(30)]],
    lat: [
      this.editar.locPre.latitud?.toFixed(8),
      [
        Validators.required,
        Validators.max(15),
        Validators.min(-5),
    ...
    lon: [
      this.editar.locPre.longitud?.toFixed(8),
      [
        Validators.required,
        Validators.max(-65),
        Validators.min(-83),
    ...
    dir02: [
      this.editar.locPreDir.dir02,
      [Validators.max(1000), Validators.min(0)],
    ],
    dir03: [this.editar.locPreDir.dir03],
    dir04: [this.editar.locPreDir.dir04],
    dir05: [this.editar.locPreDir.dir05],
    dir06: [
      this.editar.locPreDir.dir06,
      [Validators.max(1000), Validators.min(0)],
    ],
    dir07: [this.editar.locPreDir.dir07],
    dir08: [this.editar.locPreDir.dir08],
    dirrur: [this.editar.locPreDir.dirrur, [Validators.maxLength(100)]],
  });
  ...
  handleChange(dto: any) {
    this.formUserLoca.value.mun = String(this.editar.locPre.municipio?.valueOf);
  ...
  noVistaDir: boolean =
    this.editar.idenPredio.tipo_predio === 'URBANO' ? true : false;
  ...
  procesar() {
    ...
    this.objIdenLoc.id_oferta = this.editar.idenPredio.id_oferta?.valueOf();
    ...
    this.objIdenLocDir.id_oferta = this.editar.idenPredio.id_oferta?.valueOf();
    ...
    if (
      ...
      JSON.stringify(this.editar.locPre) !== JSON.stringify(this.objIdenLoc)
    ) {
      this.api
        ...
        .subscribe((resLocpre) => {
          if (resLocpre.status === '200 OK') {
            ...
            this.editar.setLocaPredio = this.objIdenLoc;
            this.editar.setLocaPredioDir = this.objIdenLocDir;

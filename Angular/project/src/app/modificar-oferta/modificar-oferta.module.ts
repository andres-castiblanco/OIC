...
@NgModule({
  declarations: [ModOferComponent, FooterComponent, HeaderComponent, NavComponent, LocPreValComponent, InfFueValComponent, LocPreEditComponent, InfFueEditComponent, InfFisEditComponent, InfEcoEditComponent, IdenPreEditComponent, DatGenEditComponent],

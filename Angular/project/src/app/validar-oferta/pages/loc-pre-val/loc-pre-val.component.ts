...
@Component({
  selector: 'app-loc-pre-val',
  templateUrl: './loc-pre-val.component.html',
  styleUrls: ['./loc-pre-val.component.css'],
})
export class LocPreValComponent {
  constructor(
  ...
  get estado_oferta() {
    return this.formUserLoca.get('estado_oferta') as FormControl;
  }

  get obs_verifica() {
    return this.formUserLoca.get('obs_verifica') as FormControl;
  }
  ...
  formUserLoca = this.fb.group({
    idoferta: [
      { value: this.validar.idenPredio.id_oferta, disabled: true },
      Validators.required,
    ],
    dep: [
      { value: this.validar.locPre.departamento, disabled: true },
      Validators.required,
    ],
    mun: [
      { value: this.validar.locPre.municipio, disabled: true },
      Validators.required,
    ],
    nombar: [
      { value: this.validar.locPre.barrio, disabled: true },
      [Validators.maxLength(30)],
    ],
    nomver: [
      { value: this.validar.locPre.vereda, disabled: true },
      [Validators.maxLength(30)],
    ],
    lat: [
      { value: this.validar.locPre.latitud?.toFixed(8), disabled: true },
      [
        Validators.required,
        Validators.max(15),
        Validators.min(-5),
    ...
    lon: [
      { value: this.validar.locPre.longitud?.toFixed(8), disabled: true },
      [
        Validators.required,
        Validators.max(-65),
        Validators.min(-83),
    ...
    direccion: [
      { value: this.validar.locPre.direccion, disabled: true },
      ,
      [Validators.maxLength(100)],
    ],
    dir01: [{ value: this.validar.locPreDir.dir01, disabled: true }],
    dir02: [
      { value: this.validar.locPreDir.dir02, disabled: true },
      [Validators.max(1000), Validators.min(0)],
    ],
    dir03: [{ value: this.validar.locPreDir.dir03, disabled: true }],
    dir04: [{ value: this.validar.locPreDir.dir04, disabled: true }],
    dir05: [{ value: this.validar.locPreDir.dir05, disabled: true }],
    dir06: [
      { value: this.validar.locPreDir.dir06, disabled: true },
      [Validators.max(1000), Validators.min(0)],
    ],
    dir07: [{ value: this.validar.locPreDir.dir07, disabled: true }],
    dir08: [{ value: this.validar.locPreDir.dir08, disabled: true }],
    dirrur: [
      { value: this.validar.locPreDir.dirrur, disabled: true },
      [Validators.maxLength(100)],
    ],
    estado_oferta: [
      {
  ...
  handleChange(dto: any) {
    this.formUserLoca.value.mun = String(
      this.validar.locPre.municipio?.valueOf
    );
  ...
  noVistaDir: boolean =
    this.validar.idenPredio.tipo_predio === 'URBANO' ? true : false;
  ...
  procesar() {
    ...
    this.objIdenPre.estado_oferta = String(
      this.formUserLoca.value.estado_oferta?.valueOf()
    );
    this.objIdenPre.obs_verifica =
      this.formUserLoca.value.obs_verifica?.valueOf() == '' ||
      this.formUserLoca.value.obs_verifica?.valueOf() == undefined ||
      this.formUserLoca.value.obs_verifica?.valueOf() == null
        ? 'Sin observaciones.'
        : this.formUserLoca.value.obs_verifica?.valueOf();
